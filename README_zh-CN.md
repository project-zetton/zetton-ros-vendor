...
zetton-ros-vendor 是 zetton 系列软件包的一个开源扩展，它使用 ROS 框架实现节点间的通信。它是 [Project Zetton](https://github.com/project-zetton) 的一部分。

## 最新进展

有关详细信息和发布历史，请参阅 [changelog.md](docs/zh_CN/changelog.md) 。

有关 zetton-ros-vendor 不同版本之间的兼容性更改，请参阅 [compatibility.md](docs/zh_CN/compatibility.md) 。
...
请查看 [快速入门指南](docs/zh_CN/get_started.md) 以了解 zetton-ros-vendor 的基本用法。
...
我们感谢所有为改进 zetton-ros-vendor 做出贡献的人。请参考 [贡献指南](.github/CONTRIBUTING.md) 了解参与项目贡献的相关指引。
...
- [zetton-common](https://github.com/project-zetton/zetton-common): 含有通用定义和工具的软件包
